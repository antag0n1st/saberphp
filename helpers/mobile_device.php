...
class MobileDevice {
     ...
     * @param type $android
     * @param type $opera
     * @param type $blackberry
     * @param type $palm
     * @param type $windows
     * @param type $mobileredirect
     * @param type $desktopredirect
     * @return boolean 
     */
    public static function detect($iphone = true, $ipad = true, $android = true, $opera = true, $blackberry = true, $palm = true, $windows = true, $mobileredirect = false, $desktopredirect = false) {

        if (!isset($_SERVER['HTTP_USER_AGENT']) or !isset($_SERVER['HTTP_ACCEPT'])) {
            return;
        }
